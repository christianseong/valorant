...
<div class="articlelist mx-auto">
    <v-row class="mx-auto my-10" style="max-width:1264px;" no-gutters>
        <v-col cols="12" lg="9">
            <v-row style="height:88px;" no-gutters>
                ...
                <v-col class="d-flex align-center" cols="auto">
                    ...
                    <v-btn-toggle dense color="green" background-color="white" mandatory v-model="toggle">
                        <v-btn class="py-4" small>
                            <v-icon style="color:inherit;">mdi-image-text</v-icon>
                            <p class="sliderTitleText" v-if="!$vuetify.breakpoint.mdAndDown">요약형</p>
                        </v-btn>
                        <v-btn class="py-4" small>
                            <v-icon style="color:inherit;">mdi-format-align-justify</v-icon>
                            <p class="sliderTitleText" v-if="!$vuetify.breakpoint.mdAndDown">제목형</p>
                        </v-btn>
                        <v-btn class="py-4" small>
                            <v-icon style="color:inherit;">mdi-image</v-icon>
                            <p class="sliderTitleText" v-if="!$vuetify.breakpoint.mdAndDown">포토형</p>
                        </v-btn>
                    </v-btn-toggle>

                    <div class="mx-2" style="border:1px solid #ddd;">
                        <select class="pa-1" v-model="limit">
                            <option value="10">10개씩</option>
                            <option value="15">15개씩</option>
                            <option selected value="20">20개씩</option>
                            <option value="30">30개씩</option>
                        </select>
                    </div>
                </v-col>
            </v-row>
            <v-divider style="border-color:#dce4ec;"></v-divider>
            ...
            <v-row class="my-10" v-if="toggle===1" no-gutters>
                <v-col class="my-1" v-for="(i,index) in boardResult" :key="index" cols="12">
                    ...
                    <v-divider class="my-5" v-if="(index===4||index===9||index===14)"></v-divider>
                </v-col>
            </v-row>
        ...
        <v-col v-if="!this.$vuetify.breakpoint.mdAndDown" cols="3">
            ...
            <v-divider style="width:90%; border-color:#dce4ec;"></v-divider>
            <v-row  no-gutters>
                <v-col cols="12">
...
select {
    ...
    font-family: inherit;
    background: url('../assets/icons/arrow.jpg') no-repeat 95% 50%;
    border-radius: 0px;
